      ...
      <section className="py-6  dark:bg-gray-100 dark:text-gray-800">
        <div className="container flex flex-col items-center justify-center p-4 mx-auto sm:p-10">
          ...
          <div className="flex flex-row flex-wrap-reverse justify-center mt-12">
            <div
              className="flex flex-col justify-center w-full px-8 mx-6 my-12 text-center rounded-md md:w-96 lg:w-80 xl:w-64 dark:bg-gray-800 dark:text-gray-100 bg-[#0da5e9] text-white"
              data-aos="fade-right"
              data-aos-duration="1000"
              data-aos-easing="linear"
            >
